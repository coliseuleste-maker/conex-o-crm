    ...
    >
      ...
      {!collapsed && (
        <div className="px-3 py-3 border-b border-sidebar-border">
          <label className="text-[10px] uppercase tracking-wider text-sidebar-muted font-semibold mb-1 block">
            Empresa
          </label>
          <Select
      ...
      <button
        ...
        className="mx-2 mb-3 p-2 rounded-lg hover:bg-sidebar-accent text-sidebar-muted transition-colors flex items-center justify-center"
      >
