...
export const mockAIAgents: AIAgent[] = [
  { id: "a1", userId: "u3", name: "Agente do Pedro", status: "active", knowledgeBase: ["Vendas B2B", "Negociação avançada", "Produtos de tecnologia"], communicationStyle: "Profissional e consultivo", commercialStrategy: "Solution selling com foco em ROI", totalInteractions: 245, successRate: 72, lastTraining: "2025-12-10", capabilities: ["Qualificação", "Follow-up", "Agendamento"] },
  { id: "a2", userId: "u4", name: "Agente da Maria", status: "training", knowledgeBase: ["Prospecção outbound", "Cold calling", "Qualificação BANT"], communicationStyle: "Direto e empático", commercialStrategy: "Abordagem consultiva para qualificação", totalInteractions: 120, successRate: 65, lastTraining: "2025-12-08", capabilities: ["Qualificação", "Mensagens personalizadas"] },
  { id: "a3", userId: "u6", name: "Agente da Juliana", status: "active", knowledgeBase: ["Propostas comerciais", "Fechamento", "Upsell"], communicationStyle: "Persuasivo e detalhista", commercialStrategy: "Challenger Sale com insights de mercado", totalInteractions: 180, successRate: 78, lastTraining: "2025-12-12", capabilities: ["Propostas", "Follow-up", "Negociação"] },
];
